...
export const attributesHelpLink = `${DOCUMENTATION_URL}/manuale-operativo/attributi`
...
export const manageEServiceGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/e-service`
export const importExportEServiceGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/e-service#esportare-ed-importare-un-e-service`
export const implementAndManageEServiceGuideLink = `${DOCUMENTATION_URL}/tutorial/tutorial-per-lerogatore/come-creare-un-nuovo-e-service`
export const voucherVerificationGuideLink = `${DOCUMENTATION_URL}/tutorial/tutorial-per-lerogatore/come-verificare-il-digest-di-un-voucher`
...
export const purposeUpgradeGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/finalita`
export const agreementUpgradeGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/richieste-di-fruizione#fruitore-aggiornare-una-richiesta-di-fruizione`
...
export const apiGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/api-esposte-da-pdnd-interoperabilita`
export const delegationGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/deleghe`
...
export const keychainGuideLink = `${DOCUMENTATION_URL}/manuale-operativo/utilizzare-i-voucher#garanzia-dellintegrita-della-risposta`
