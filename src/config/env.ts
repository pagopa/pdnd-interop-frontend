...
const DEV_FEATURE_FLAG_AGREEMENT_APPROVAL_POLICY_EDITABLE = import.meta.env
  .REACT_APP_FEATURE_FLAG_AGREEMENT_APPROVAL_POLICY_EDITABLE

export const FEATURE_FLAG_AGREEMENT_APPROVAL_POLICY_EDITABLE =
  isProduction && PAGOPA_ENV
    ? !!(PAGOPA_ENV.FEATURE_FLAG_AGREEMENT_APPROVAL_POLICY_EDITABLE == 'true')
    : !!(DEV_FEATURE_FLAG_AGREEMENT_APPROVAL_POLICY_EDITABLE == 'true')
...
const DEV_FEATURE_FLAG_ADMIN_CLIENT_API = import.meta.env.REACT_APP_FEATURE_FLAG_ADMIN_CLIENT_API

export const FEATURE_FLAG_ADMIN_CLIENT_API =
  isProduction && PAGOPA_ENV
    ? !!(PAGOPA_ENV.FEATURE_FLAG_ADMIN_CLIENT_API == 'true')
    : !!(DEV_FEATURE_FLAG_ADMIN_CLIENT_API == 'true')
