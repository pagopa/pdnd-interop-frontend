...
export const FEATURE_FLAG_SIGNALHUB_WHITELIST = !!(
  import.meta.env.FEATURE_FLAG_SIGNALHUB_WHITELIST == 'true'
)
// If FEATURE_FLAG_SIGNALHUB_WHITELIST is enabled, Signal Hub is accessible only to tenants listed in the whitelist (Producer).
export const SIGNALHUB_WHITELIST_PRODUCER =
  FEATURE_FLAG_SIGNALHUB_WHITELIST && import.meta.env.SIGNALHUB_WHITELIST_PRODUCER
// If FEATURE_FLAG_SIGNALHUB_WHITELIST is enabled, Signal Hub is accessible only to tenants listed in the whitelist (Consumer).
export const SIGNALHUB_WHITELIST_CONSUMER =
  FEATURE_FLAG_SIGNALHUB_WHITELIST && import.meta.env.SIGNALHUB_WHITELIST_CONSUMER
