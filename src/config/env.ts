...
const DEV_FEATURE_FLAG_ADMIN_CLIENT = import.meta.env.REACT_APP_FEATURE_FLAG_ADMIN_CLIENT

export const FEATURE_FLAG_ADMIN_CLIENT =
  isProduction && PAGOPA_ENV
    ? !!(PAGOPA_ENV.FEATURE_FLAG_ADMIN_CLIENT == 'true')
    : !!(DEV_FEATURE_FLAG_ADMIN_CLIENT == 'true')
