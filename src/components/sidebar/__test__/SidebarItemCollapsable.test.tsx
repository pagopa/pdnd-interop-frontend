...
describe('SidebarItemCollapsable', () => {
  ...
  it('should render label and icon of root element', () => {
    render(<SidebarItemGroup {...defaultProps} />)
