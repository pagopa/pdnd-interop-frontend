...
const interopSidenavRoutes: SidebarRoutes = [
  {
  ...
  },
  {
    ...
    children: [
      ...
      { to: 'PROVIDE_PURPOSE_LIST', label: 'Finalità inoltrate' },
    ],
    divider: false,
  },
]
...
describe('useGetSidebarItems', () => {
  it('should return empty navigation list if jwt not contain roles', () => {
    ...
    const { result } = renderHook(() => useGetSidebarItems(interopSidenavRoutes))
