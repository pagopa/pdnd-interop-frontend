...
import { AttributeContainerRow, AttributeContainerRowSkeleton } from '../AttributeContainerRow'
import { renderWithApplicationContext } from '@/utils/testing.utils'
import { vi } from 'vitest'
import userEvent from '@testing-library/user-event'
import { render } from '@testing-library/react'

describe('AttributeContainerRow', () => {
  it('should match snapshot', () => {
    const screen = renderWithApplicationContext(
      <AttributeContainerRow attribute={{ id: 'test-id', name: 'Test' }} />,
  ...
  it('should match snapshot with the "or" label', () => {
    const screen = renderWithApplicationContext(
      <AttributeContainerRow attribute={{ id: 'test-id', name: 'Test' }} showOrLabel />,
      { withReactQueryContext: true }
    )
    expect(screen.baseElement).toMatchSnapshot()
  })
...
describe('AttributeContainerRowSkeleton', () => {
  it('should match snapshot', () => {
    const screen = render(<AttributeContainerRowSkeleton />)
    expect(screen.baseElement).toMatchSnapshot()
  })
})
