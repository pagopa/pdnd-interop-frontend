...
type EServiceTemplateUpdateAttributesDrawerProps = {
  isOpen: boolean
  onClose: () => void
...
export const EServiceTemplateUpdateAttributesDrawer: React.FC<
  EServiceTemplateUpdateAttributesDrawerProps
