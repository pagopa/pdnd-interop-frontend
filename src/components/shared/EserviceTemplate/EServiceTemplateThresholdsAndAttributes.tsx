...
import { EServiceTemplateAttributes } from './EServiceTemplateAttributes'

type EServiceTemplateThresholdsAndAttributesProps = {
  readonly: boolean
  routeKey: 'SUBSCRIBE_ESERVICE_TEMPLATE_DETAILS' | 'PROVIDE_ESERVICE_TEMPLATE_DETAILS'
}
export const EServiceTemplateThresholdsAndAttributes: React.FC<
  EServiceTemplateThresholdsAndAttributesProps
> = ({ routeKey, readonly }) => {
