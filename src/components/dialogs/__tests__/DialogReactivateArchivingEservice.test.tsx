...
const renderDialog = (overrides: Partial<DialogReactivateArchivingEserviceProps> = {}) => {
  const props: DialogReactivateArchivingEserviceProps = {
    type: 'reactivateArchivingEservice',
    eserviceId: 'eservice-id',
    descriptorId: 'descriptor-id',
    ...overrides,
  }
  return renderWithApplicationContext(<DialogReactivateArchivingEservice {...props} />, {
    withReactQueryContext: true,
    withRouterContext: true,
  })
}

describe('DialogReactivateArchivingEservice', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
