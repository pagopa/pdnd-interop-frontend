...
type ConsumerPurposeDetailsDailyCallsThresholdsCardProps = {
  dailyCallsTotal: number
  dailyCallsPerConsumer: number
}

export const ConsumerPurposeDetailsDailyCallsThresholdsCard: React.FC<
  ConsumerPurposeDetailsDailyCallsThresholdsCardProps
> = ({ dailyCallsTotal, dailyCallsPerConsumer }) => {
  const { t } = useTranslation('purpose', {
    keyPrefix: 'consumerView.sections.loadEstimate.thresholdsCard',
  })
