...
export function useNotificationInAppConfigForm(type: NotificationConfigType) {
            ...
            components: [
              {
                ...
                title:
                  t('provider.eserviceTemplate.components.instanceFromTemplate.label') + '(17)',
                description: t(
              ...
              },
              {
                ...
                title:
                  t('provider.eserviceTemplate.components.templateStateUpdated.label') + '(19)',
                description: t(
            ...
            components: [
              {
                ...
                title:
                  t('delegation.delegationReceive.components.delegationUpdated.label') + '(23)',
                description: t(
