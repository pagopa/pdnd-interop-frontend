...
type KeychainPublicKeyGeneralInfoSectionProps = {
  keychainId: string
  keyId: string
}

export const KeychainPublicKeyGeneralInfoSection: React.FC<
  KeychainPublicKeyGeneralInfoSectionProps
> = ({ keychainId, keyId }) => {
...
export const KeychainPublicKeyGeneralInfoSectionSkeleton = () => {
  return (
    <Grid container>
      <Grid item xs={7}>
