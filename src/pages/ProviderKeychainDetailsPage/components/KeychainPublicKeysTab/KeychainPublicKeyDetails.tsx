...
import {
  KeychainPublicKeyGeneralInfoSection,
  KeychainPublicKeyGeneralInfoSectionSkeleton,
} from './KeychainPublicKeyGeneralInfoSection'

export const KeychainPublicKeyDetails: React.FC = () => {
  ...
  return (
    ...
    >
      <React.Suspense fallback={<KeychainPublicKeyGeneralInfoSectionSkeleton />}>
        {publicKey?.isOrphan && (
        ...
        <KeychainPublicKeyGeneralInfoSection keychainId={keychainId} keyId={keyId} />
      </React.Suspense>
    </PageContainer>
  )
}
