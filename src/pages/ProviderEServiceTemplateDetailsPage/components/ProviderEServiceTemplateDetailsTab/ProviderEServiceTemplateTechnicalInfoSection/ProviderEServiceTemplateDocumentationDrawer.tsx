...
type ProviderEServiceTemplateUpdateDocumentationDrawerProps = {
  isOpen: boolean
...
export const ProviderEServiceTemplateUpdateDocumentationDrawer: React.FC<
  ProviderEServiceTemplateUpdateDocumentationDrawerProps
