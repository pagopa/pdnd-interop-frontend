...
type ProviderKeychainUserDetailsGeneralInfoSectionProps = {
  keychainId: string
  userId: string
}

export const ProviderKeychainUserDetailsGeneralInfoSection: React.FC<
  ProviderKeychainUserDetailsGeneralInfoSectionProps
> = ({ keychainId, userId }) => {
...
export const ProviderKeychainUserDetailsGeneralInfoSectionSkeleton: React.FC = () => {
