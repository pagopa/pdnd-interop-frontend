...
L'ente che intende erogare un E-Service potrà crearlo e gestirlo dalla voce di menù "Erogazione > I miei E-Service". Una volta pubblicato un E-Service, sarà reso disponibile sul catalogo degli E-Service, visualizzabile in modalità fruizione ("Fruizione > Catalogo E-Service"). Gli enti interessati a fruire dell'E-Service, e in possesso dei requisiti minimi richiesti dall'erogatore, potranno iscriversi presentando una richiesta di fruizione. Ogni ente erogatore troverà le richieste di fruizione presentate dai fruitori in "Erogazione > Richieste di fruizione", dove potrà gestirle. Quando una richiesta viene approvata, l'aderente fruitore potrà presentare delle finalità e iniziare a utilizzare l'E-Service messo a disposizione dall'erogatore.

### Flusso del fruitore

L'aderente che intende fruire di un E-Service potrà visualizzare tutti quelli disponibili andando su "Fruizione > Catalogo E-Service". Se possiede i requisiti minimi per usufruirne, visualizzerà un pulsante "Iscriviti", attraverso il quale potrà presentare una richiesta di fruizione che l'ente erogatore valuterà. Una volta che la richiesta di fruizione è approvata e attiva, l'aderente fruitore potrà creare delle finalità. In ogni finalità, dovrà indicare il dettaglio sull'accesso e l'utilizzo dei dati e la stima della quantità di richieste che insisteranno sull'ente erogatore (numero di chiamate API nell'unità di tempo). Ad ogni finalità potrà associare uno o più client. Le chiavi contenute in quei client potranno essere utilizzate per contattare l'ente erogatore dell'E-Service a cui la finalità è associata, secondo il meccanismo della client assertion.
